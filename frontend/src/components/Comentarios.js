    ...
    <div className="">
      ...
      <div className="row comentarios justify-content-center">
        <div className="col-10">
          ...
          <div className="media">
            <img src="./imagenes_PPI/Playa.jpg" width="64" height="64" alt="" />
          ...
          <div className="media">
            <img src="./imagenes_PPI/Room.jpg" width="64" height="64" alt="" />
            <div className="media-body">
              <p className="nombre">
          ...
          <div className="media">
            <img src="./imagenes_PPI/Rocas.jpg" width="64" height="64" alt="" />
            <div className="media-body">
              <p className="nombre">
          ...
          <div className="media">
            ...
            <div className="media-body">
              ...
              <p className="comentario">
                Desde la cima de logra una maravillosa vista de la ciudad. Tiene
                caminos preciosos y lugares para fotos muy buenos
              </p>
            </div>
          </div>
          ...
          <div className="media">
            <img src="./imagenes_PPI/Foto.jpg" width="64" height="64" alt="" />
            <div className="media-body">
              <p className="nombre">
