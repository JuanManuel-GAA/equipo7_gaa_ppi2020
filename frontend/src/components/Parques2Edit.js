      ...
      <div className="accordion" id="accordionExample">
        <div className="card">
          <div className="card-header" id="headingOne">
            <h2 className="mb-0">
               {/* ESTE ES EL BOTÓN EDIT DE "INFORMACIÓN DE TRANSPORTE" */}
              <button type="button" className="btn Editar inline-flex">
        ...
        <div className="card">
          <div className="card-header" id="headingTwo">
            <h2 className="mb-0">
              {/* POR FÍN ENCONTRÉ CÓMO PONER COMENTARIOS, SIIIIIIIIII.
              ESTE ES EL BOTÓN EDIT DE "HISTORIA"
              */}
              <button type="button" className="btn Editar inline-flex">
                <FontAwesomeIcon icon={["fas", "edit"]} />
              </button>
