    ...
    <div className="Ppicontainer">
      <BrowserRouter>
        <React.Fragment>
          ...
          <Route path="/Inicio1" exact component={Inicio1} />
          ...
          <Route path="/Inicio2" exact component={Inicio2} />
          ...
          <Route path="/RecomendacionesEdit" exact component={RecomendacionesEdit} />
          ...
          <Route path="/VerificacionCalificar" exact component={VerificacionCalificar} />
